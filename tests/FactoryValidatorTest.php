...
class FactoryValidatorTest extends TestCase
{
     ...
     */
    public function testICanGetValidatorWithFactory(string $type, string $expectedClass)
    {
     ...
     * @return void
     */
    public function testIHaveAnExceptionWhenITryToGetValidatorWithInvalidType()
    {
